...
![Username](/assets/machines/vulnhub/dc2/1.png)
...
![Username](/assets/machines/vulnhub/dc2/2.png)
## From Tom to Jerry
...
I ran diffreent Enumeration scripts and found an intersting sudo privilege which allows us to run git as root. after searching in the gtfio of how to get a root shell. I ran the following commands.
